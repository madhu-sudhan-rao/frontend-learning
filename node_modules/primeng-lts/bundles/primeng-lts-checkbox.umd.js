(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/checkbox', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].checkbox = {}), global.ng.core, global.ng.common, global.ng.forms, global["primeng-lts"].utils));
})(this, (function (exports, i0, i1, forms, utils) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Checkbox = /** @class */ (function () {
        ...
        Checkbox.prototype.updateModel = function (event) {
            ...
            if (!this.binary) {
                if (this.checked())
                    newModelValue = this.model.filter(function (val) { return !utils.ObjectUtils.equals(val, _this.value); });
                else
                    newModelValue = this.model ? __spreadArray(__spreadArray([], __read(this.model)), [this.value]) : [this.value];
        ...
        Checkbox.prototype.checked = function () {
            return this.binary ? this.model === this.trueValue : utils.ObjectUtils.contains(this.value, this.model);
        };
        return Checkbox;
    }());
