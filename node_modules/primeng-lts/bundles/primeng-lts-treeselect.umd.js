(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/ripple'), require('primeng-lts/api'), require('@angular/animations'), require('@angular/forms'), require('primeng-lts/dom'), require('primeng-lts/tree'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/treeselect', ['exports', '@angular/core', '@angular/common', 'primeng-lts/ripple', 'primeng-lts/api', '@angular/animations', '@angular/forms', 'primeng-lts/dom', 'primeng-lts/tree', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].treeselect = {}), global.ng.core, global.ng.common, global["primeng-lts"].ripple, global["primeng-lts"].api, global.ng.animations, global.ng.forms, global["primeng-lts"].dom, global["primeng-lts"].tree, global["primeng-lts"].utils));
...
//# sourceMappingURL=primeng-lts-treeselect.umd.js.map
