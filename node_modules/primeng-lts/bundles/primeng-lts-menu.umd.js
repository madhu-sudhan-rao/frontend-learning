(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('@angular/router'), require('primeng-lts/ripple'), require('primeng-lts/tooltip'), require('primeng-lts/api')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/menu', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/utils', '@angular/router', 'primeng-lts/ripple', 'primeng-lts/tooltip', 'primeng-lts/api'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].menu = {}), global.ng.core, global.ng.animations, global.ng.common, global["primeng-lts"].dom, global["primeng-lts"].utils, global.ng.router, global["primeng-lts"].ripple, global["primeng-lts"].tooltip, global["primeng-lts"].api));
})(this, (function (exports, i0, animations, i1, dom, utils, i2, i3, i5, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MenuItemContent = /** @class */ (function () {
        ...
        MenuItemContent.prototype.onItemKeyDown = function (event) {
        ...
        MenuItemContent.prototype.findNextItem = function (item) {
        ...
        MenuItemContent.prototype.findPrevItem = function (item) {
    ...
    var Menu = /** @class */ (function () {
        function Menu(el, renderer, cd, config, overlayService) {
            this.el = el;
        ...
        Menu.prototype.onOverlayAnimationEnd = function (event) {
            switch (event.toState) {
                case 'void':
                    if (this.autoZIndex) {
        ...
        Menu.prototype.onOverlayClick = function (event) {
            if (this.popup) {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: Menu, decorators: [{
                type: i0.Component,
                args: [{
                        selector: 'p-menu',
                        template: "\n        <div #container [ngClass]=\"{'p-menu p-component': true, 'p-menu-overlay': popup}\"\n            [class]=\"styleClass\" [ngStyle]=\"style\" *ngIf=\"!popup || visible\" (click)=\"onOverlayClick($event)\"\n            [@overlayAnimation]=\"{value: 'visible', params: {showTransitionParams: showTransitionOptions, hideTransitionParams: hideTransitionOptions}}\" [@.disabled]=\"popup !== true\" (@overlayAnimation.start)=\"onOverlayAnimationStart($event)\" (@overlayAnimation.done)=\"onOverlayAnimationEnd($event)\">\n            <ul class=\"p-menu-list p-reset\" role=\"menu\">\n                <ng-template ngFor let-submenu [ngForOf]=\"model\" *ngIf=\"hasSubMenu()\">\n                    <li class=\"p-menu-separator\" *ngIf=\"submenu.separator\" [ngClass]=\"{'p-hidden': submenu.visible === false}\" role=\"separator\"></li>\n                    <li class=\"p-submenu-header\" [attr.data-automationid]=\"submenu.automationId\" *ngIf=\"!submenu.separator\" [ngClass]=\"{'p-hidden': submenu.visible === false}\" role=\"none\">\n                        <span *ngIf=\"submenu.escape !== false; else htmlSubmenuLabel\">{{submenu.label}}</span>\n                        <ng-template #htmlSubmenuLabel><span [innerHTML]=\"submenu.label\"></span></ng-template>\n                    </li>\n                    <ng-template ngFor let-item [ngForOf]=\"submenu.items\">\n                        <li class=\"p-menu-separator\" *ngIf=\"item.separator\" [ngClass]=\"{'p-hidden': (item.visible === false ||\u00A0submenu.visible === false)}\" role=\"separator\"></li>\n                        <li class=\"p-menuitem\" *ngIf=\"!item.separator\" [pMenuItemContent]=\"item\" [ngClass]=\"{'p-hidden': (item.visible === false || submenu.visible === false)}\" [ngStyle]=\"item.style\" [class]=\"item.styleClass\" role=\"none\"></li>\n                    </ng-template>\n                </ng-template>\n                <ng-template ngFor let-item [ngForOf]=\"model\" *ngIf=\"!hasSubMenu()\">\n                    <li class=\"p-menu-separator\" *ngIf=\"item.separator\" [ngClass]=\"{'p-hidden': item.visible === false}\" role=\"separator\"></li>\n                    <li class=\"p-menuitem\" *ngIf=\"!item.separator\" [pMenuItemContent]=\"item\" [ngClass]=\"{'p-hidden': item.visible === false}\" [ngStyle]=\"item.style\" [class]=\"item.styleClass\" pTooltip [tooltipOptions]=\"item.tooltipOptions\" role=\"none\"></li>\n                </ng-template>\n            </ul>\n        </div>\n    ",
    ...
    MenuModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MenuModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    MenuModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MenuModule, declarations: [Menu, MenuItemContent], imports: [i1.CommonModule, i2.RouterModule, i3.RippleModule, i5.TooltipModule], exports: [Menu, i2.RouterModule, i5.TooltipModule] });
    MenuModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MenuModule, imports: [[i1.CommonModule, i2.RouterModule, i3.RippleModule, i5.TooltipModule], i2.RouterModule, i5.TooltipModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MenuModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i2.RouterModule, i3.RippleModule, i5.TooltipModule],
                        exports: [Menu, i2.RouterModule, i5.TooltipModule],
...
//# sourceMappingURL=primeng-lts-menu.umd.js.map
