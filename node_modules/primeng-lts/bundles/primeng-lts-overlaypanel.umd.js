(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/ripple'), require('@angular/animations'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/overlaypanel', ['exports', '@angular/core', '@angular/common', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/ripple', '@angular/animations', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].overlaypanel = {}), global.ng.core, global.ng.common, global["primeng-lts"].dom, global["primeng-lts"].api, global["primeng-lts"].ripple, global.ng.animations, global["primeng-lts"].utils));
