(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('@angular/forms'), require('primeng-lts/utils'), require('primeng-lts/api')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/colorpicker', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', '@angular/forms', 'primeng-lts/utils', 'primeng-lts/api'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].colorpicker = {}), global.ng.core, global.ng.animations, global.ng.common, global["primeng-lts"].dom, global.ng.forms, global["primeng-lts"].utils, global["primeng-lts"].api));
...
//# sourceMappingURL=primeng-lts-colorpicker.umd.js.map
