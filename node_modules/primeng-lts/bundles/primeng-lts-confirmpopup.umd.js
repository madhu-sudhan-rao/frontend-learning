(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/button'), require('primeng-lts/utils'), require('@angular/animations'), require('primeng-lts/dom')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/confirmpopup', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/button', 'primeng-lts/utils', '@angular/animations', 'primeng-lts/dom'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].confirmpopup = {}), global.ng.core, global.ng.common, global["primeng-lts"].api, global["primeng-lts"].button, global["primeng-lts"].utils, global.ng.animations, global["primeng-lts"].dom));
    ...
    var ConfirmPopup = /** @class */ (function () {
        ...
        ConfirmPopup.prototype.getElementToFocus = function () {
            switch (this.defaultFocus) {
                case 'accept':
                    return dom.DomHandler.findSingle(this.container, '.p-confirm-popup-accept');
                case 'reject':
                    return dom.DomHandler.findSingle(this.container, '.p-confirm-popup-reject');
                case 'none':
                    return null;
            }
        };
...
//# sourceMappingURL=primeng-lts-confirmpopup.umd.js.map
