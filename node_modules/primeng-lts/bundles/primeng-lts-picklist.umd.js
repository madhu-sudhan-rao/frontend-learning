(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/button'), require('primeng-lts/api'), require('primeng-lts/dom'), require('primeng-lts/ripple'), require('@angular/cdk/drag-drop'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/picklist', ['exports', '@angular/core', '@angular/common', 'primeng-lts/button', 'primeng-lts/api', 'primeng-lts/dom', 'primeng-lts/ripple', '@angular/cdk/drag-drop', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].picklist = {}), global.ng.core, global.ng.common, global["primeng-lts"].button, global["primeng-lts"].api, global["primeng-lts"].dom, global["primeng-lts"].ripple, global.ng.cdk.dragDrop, global["primeng-lts"].utils));
...
//# sourceMappingURL=primeng-lts-picklist.umd.js.map
