(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/tooltip'), require('primeng-lts/ripple'), require('primeng-lts/api'), require('primeng-lts/dom')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/tabview', ['exports', '@angular/core', '@angular/common', 'primeng-lts/tooltip', 'primeng-lts/ripple', 'primeng-lts/api', 'primeng-lts/dom'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].tabview = {}), global.ng.core, global.ng.common, global["primeng-lts"].tooltip, global["primeng-lts"].ripple, global["primeng-lts"].api, global["primeng-lts"].dom));
...
//# sourceMappingURL=primeng-lts-tabview.umd.js.map
