(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/button'), require('primeng-lts/ripple'), require('primeng-lts/dom'), require('primeng-lts/api'), require('@angular/forms'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/calendar', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/button', 'primeng-lts/ripple', 'primeng-lts/dom', 'primeng-lts/api', '@angular/forms', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].calendar = {}), global.ng.core, global.ng.animations, global.ng.common, global["primeng-lts"].button, global["primeng-lts"].ripple, global["primeng-lts"].dom, global["primeng-lts"].api, global.ng.forms, global["primeng-lts"].utils));
    ...
    ***************************************************************************** */
    ...
    var Calendar = /** @class */ (function () {
        ...
        Calendar.prototype.createWeekDays = function () {
            this.weekDays = [];
            var dayIndex = this.getFirstDateOfWeek();
        ...
        Calendar.prototype.getSundayIndex = function () {
            var firstDayOfWeek = this.getFirstDateOfWeek();
        ...
        Calendar.prototype.enableModality = function (element) {
            ...
            if (!this.mask) {
                ...
                var maskStyleClass = 'p-component-overlay p-datepicker-mask p-datepicker-mask-scrollblocker p-component-overlay p-component-overlay-enter';
        ...
        Calendar.prototype.destroyMask = function () {
        ...
        Calendar.prototype.unbindAnimationEndListener = function () {
        ...
        Calendar.prototype.getFirstDateOfWeek = function () {
            return this._firstDayOfWeek || this.getTranslation(i1.TranslationKeys.FIRST_DAY_OF_WEEK);
        };
