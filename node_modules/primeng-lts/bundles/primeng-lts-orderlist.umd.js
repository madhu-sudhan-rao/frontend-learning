(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/button'), require('primeng-lts/api'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('primeng-lts/ripple'), require('@angular/cdk/drag-drop')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/orderlist', ['exports', '@angular/core', '@angular/common', 'primeng-lts/button', 'primeng-lts/api', 'primeng-lts/dom', 'primeng-lts/utils', 'primeng-lts/ripple', '@angular/cdk/drag-drop'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].orderlist = {}), global.ng.core, global.ng.common, global["primeng-lts"].button, global["primeng-lts"].api, global["primeng-lts"].dom, global["primeng-lts"].utils, global["primeng-lts"].ripple, global.ng.cdk.dragDrop));
})(this, (function (exports, i0, i2, i3, i1, dom, utils, i4, i5) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var OrderList = /** @class */ (function () {
        function OrderList(el, cd, filterService) {
            ...
            this.onReorder = new i0.EventEmitter();
            this.onSelectionChange = new i0.EventEmitter();
            this.onFilterEvent = new i0.EventEmitter();
        ...
        OrderList.prototype.onItemClick = function (event, item, index) {
            ...
            if (metaSelection) {
                ...
                if (selected && metaKey) {
                    ...
                    this._selection = (metaKey) ? this._selection ? __spreadArray([], __read(this._selection)) : [] : [];
                ...
                if (selected) {
                    ...
                    this._selection = this._selection ? __spreadArray([], __read(this._selection)) : [];
                    utils.ObjectUtils.insertIntoOrderedArray(item, index, this._selection, this.value);
                }
            }
            //binding
        ...
        OrderList.prototype.onDrop = function (event) {
            ...
            if (previousIndex !== currentIndex) {
                if (this.visibleOptions) {
                    ...
                    i5.moveItemInArray(this.visibleOptions, event.previousIndex, event.currentIndex);
                }
                i5.moveItemInArray(this.value, previousIndex, currentIndex);
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: OrderList, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.ChangeDetectorRef }, { type: i1__namespace.FilterService }]; }, propDecorators: { header: [{
                    type: i0.Input
                }], style: [{
                    type: i0.Input
                }], styleClass: [{
    ...
    OrderListModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: OrderListModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    OrderListModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: OrderListModule, declarations: [OrderList], imports: [i2.CommonModule, i3.ButtonModule, i1.SharedModule, i4.RippleModule, i5.DragDropModule], exports: [OrderList, i1.SharedModule, i5.DragDropModule] });
    OrderListModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: OrderListModule, imports: [[i2.CommonModule, i3.ButtonModule, i1.SharedModule, i4.RippleModule, i5.DragDropModule], i1.SharedModule, i5.DragDropModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: OrderListModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i2.CommonModule, i3.ButtonModule, i1.SharedModule, i4.RippleModule, i5.DragDropModule],
                        exports: [OrderList, i1.SharedModule, i5.DragDropModule],
...
//# sourceMappingURL=primeng-lts-orderlist.umd.js.map
