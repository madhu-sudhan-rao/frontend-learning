(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/utils'), require('primeng-lts/dom'), require('primeng-lts/ripple'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/galleria', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/utils', 'primeng-lts/dom', 'primeng-lts/ripple', '@angular/animations'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].galleria = {}), global.ng.core, global.ng.common, global["primeng-lts"].api, global["primeng-lts"].utils, global["primeng-lts"].dom, global["primeng-lts"].ripple, global.ng.animations));
})(this, (function (exports, i0, i2, i1, utils, dom, i3, animations) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Galleria = /** @class */ (function () {
        ...
        Galleria.prototype.onAnimationStart = function (event) {
            switch (event.toState) {
                case 'visible':
                    this.enableModality();
                    break;
                case 'void':
                    dom.DomHandler.addClass(this.mask.nativeElement, 'p-component-overlay-leave');
                    break;
            }
        };
        Galleria.prototype.onAnimationEnd = function (event) {
            switch (event.toState) {
                case 'void':
        ...
        Galleria.prototype.enableModality = function () {
        ...
        Galleria.prototype.disableModality = function () {
...
//# sourceMappingURL=primeng-lts-galleria.umd.js.map
