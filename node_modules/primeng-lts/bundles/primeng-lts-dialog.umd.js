(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/focustrap'), require('primeng-lts/ripple'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/dialog', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/focustrap', 'primeng-lts/ripple', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].dialog = {}), global.ng.core, global.ng.animations, global.ng.common, global["primeng-lts"].dom, global["primeng-lts"].api, global["primeng-lts"].focustrap, global["primeng-lts"].ripple, global["primeng-lts"].utils));
...
//# sourceMappingURL=primeng-lts-dialog.umd.js.map
