(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('@angular/forms'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/utils'), require('primeng-lts/inputtext')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/password', ['exports', '@angular/core', '@angular/common', '@angular/animations', '@angular/forms', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/utils', 'primeng-lts/inputtext'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].password = {}), global.ng.core, global.ng.common, global.ng.animations, global.ng.forms, global["primeng-lts"].dom, global["primeng-lts"].api, global["primeng-lts"].utils, global["primeng-lts"].inputtext));
    ...
    var Password = /** @class */ (function () {
        ...
        Password.prototype.onInputFocus = function (event) {
            this.focused = true;
            if (this.feedback) {
        ...
        Password.prototype.onInputBlur = function (event) {
            this.focused = false;
            if (this.feedback) {
                this.overlayVisible = false;
            }
...
//# sourceMappingURL=primeng-lts-password.umd.js.map
