(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('@angular/animations'), require('primeng-lts/dom'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/image', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', '@angular/animations', 'primeng-lts/dom', 'primeng-lts/utils'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].image = {}), global.ng.core, global.ng.common, global["primeng-lts"].api, global.ng.animations, global["primeng-lts"].dom, global["primeng-lts"].utils));
...
//# sourceMappingURL=primeng-lts-image.umd.js.map
