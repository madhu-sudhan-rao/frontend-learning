(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/button'), require('primeng-lts/ripple'), require('primeng-lts/tooltip'), require('primeng-lts/dom'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/speeddial', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/button', 'primeng-lts/ripple', 'primeng-lts/tooltip', 'primeng-lts/dom', '@angular/router'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].speeddial = {}), global.ng.core, global.ng.common, global["primeng-lts"].api, global["primeng-lts"].button, global["primeng-lts"].ripple, global["primeng-lts"].tooltip, global["primeng-lts"].dom, global.ng.router));
...
//# sourceMappingURL=primeng-lts-speeddial.umd.js.map
