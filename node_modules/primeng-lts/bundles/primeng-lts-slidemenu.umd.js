(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('@angular/router'), require('primeng-lts/utils'), require('primeng-lts/tooltip'), require('primeng-lts/api')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/slidemenu', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', '@angular/router', 'primeng-lts/utils', 'primeng-lts/tooltip', 'primeng-lts/api'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].slidemenu = {}), global.ng.core, global.ng.animations, global.ng.common, global["primeng-lts"].dom, global.ng.router, global["primeng-lts"].utils, global["primeng-lts"].tooltip, global["primeng-lts"].api));
...
//# sourceMappingURL=primeng-lts-slidemenu.umd.js.map
