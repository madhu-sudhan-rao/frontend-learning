(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/dom'), require('@angular/router'), require('primeng-lts/ripple'), require('@angular/animations'), require('primeng-lts/utils'), require('primeng-lts/tooltip'), require('primeng-lts/api')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/tieredmenu', ['exports', '@angular/core', '@angular/common', 'primeng-lts/dom', '@angular/router', 'primeng-lts/ripple', '@angular/animations', 'primeng-lts/utils', 'primeng-lts/tooltip', 'primeng-lts/api'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].tieredmenu = {}), global.ng.core, global.ng.common, global["primeng-lts"].dom, global.ng.router, global["primeng-lts"].ripple, global.ng.animations, global["primeng-lts"].utils, global["primeng-lts"].tooltip, global["primeng-lts"].api));
...
//# sourceMappingURL=primeng-lts-tieredmenu.umd.js.map
