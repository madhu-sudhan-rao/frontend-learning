(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/button'), require('primeng-lts/utils'), require('primeng-lts/ripple')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/confirmdialog', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/button', 'primeng-lts/utils', 'primeng-lts/ripple'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["primeng-lts"] = global["primeng-lts"] || {}, global["primeng-lts"].confirmdialog = {}), global.ng.core, global.ng.animations, global.ng.common, global["primeng-lts"].dom, global["primeng-lts"].api, global["primeng-lts"].button, global["primeng-lts"].utils, global["primeng-lts"].ripple));
...
//# sourceMappingURL=primeng-lts-confirmdialog.umd.js.map
